...
/**
 * PHILIPPE
 * Added to interface since it is used
 */
ODE_API void runTestStep(dWorldID w, dReal stepsize);
...
ODE_API void dBodySetQuaternionNoNormalize (dBodyID b, const dQuaternion q);
...
//Kang Edited
ODE_API void dJointUpdateAMotorAngleInEulerMode (dJointID);
ODE_API void dJointSetAMotorAngleInEulerMode(dJointID, dReal *a);
